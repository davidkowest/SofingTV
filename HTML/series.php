...
<!--Primer carousel-->
      <div class="container text-left my-3">
        <h2 class="font-weight-light" style="color: white; font: bold; padding-top: 65px;">SERIES DE ESTRENO</h2>
...
<!--Segundo carousel-->
    <div class="container text-left my-3">
      <h2 class="font-weight-light" style="color: white; font: bold;">SERIES MAS VISTAS</h2>
      <div class="row mx-auto my-auto" style="background-color: rgba(17, 17, 17, 0.322) ;">
...
<!--Tercer carousel-->
  <div class="container text-left my-3">
    <h2 class="font-weight-light" style="color: white; font: bold;">SERIES PREMIADAS</h2>
    <div class="row mx-auto my-auto" style="background-color: rgba(17, 17, 17, 0.322) ;">
...
<!--Quinto carousel-->
<div class="container text-left my-3">
    <h2 class="font-weight-light" style="color: white; font: bold;">SERIES NOVENTERAS</h2>
    <div class="row mx-auto my-auto" style="background-color: rgba(17, 17, 17, 0.322) ;">
